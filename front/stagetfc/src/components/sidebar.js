      ...
      <Nav className="flex-column">
        ...
        <Nav.Item>
          <OverlayTrigger placement="right" overlay={renderTooltip("Project")} delay={{ show: 250, hide: 400 }}>
            <Nav.Link href="/admin-dashboard/Stage"><FaProjectDiagram /> {!collapsed && "Project"}</Nav.Link>
          </OverlayTrigger>
        </Nav.Item>
        ...
        <Nav.Item>
          <OverlayTrigger placement="right" overlay={renderTooltip("Intern")} delay={{ show: 250, hide: 400 }}>
            <Nav.Link href="/admin-dashboard/Stagiaire"><FaUserGraduate /> {!collapsed && "Intern"}</Nav.Link>
          </OverlayTrigger>
        </Nav.Item>
        ...
        <Nav.Item>
          <OverlayTrigger placement="right" overlay={renderTooltip("Supervisor")} delay={{ show: 250, hide: 400 }}>
            <Nav.Link href="/admin-dashboard/Superviser"><FaUserTie /> {!collapsed && "Supervisor"}</Nav.Link>
          </OverlayTrigger>
        </Nav.Item>
        ...
        <Nav.Item>
          <OverlayTrigger placement="right" overlay={renderTooltip("Members")} delay={{ show: 250, hide: 400 }}>
            <Nav.Link href="/admin-dashboard/Member"><FaUsers /> {!collapsed && "Members"}</Nav.Link>
          </OverlayTrigger>
        </Nav.Item>
      </Nav>
    </div>
