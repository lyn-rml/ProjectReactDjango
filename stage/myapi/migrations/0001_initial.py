    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='member_person', to='myapi.person')),
            ],
        ),
        migrations.CreateModel(
            name='Intern',
            fields=[
                ...
                ('person_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Intern_person', to='myapi.person')),
            ],
        ),
        migrations.CreateModel(
            name='Supervisor',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('Id_Membre', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('person_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='supervisor_person', to='myapi.person')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intern_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapi.intern')),
                ('Project_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapi.project')),
            ],
            options={
